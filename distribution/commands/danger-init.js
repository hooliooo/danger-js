...
var setup_bot_account_1 = require("./init/setup-bot-account");
commander_1.default
...
var go = function (app) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, setupBotAccount(ui, state)];
            case 3:
                _a.sent();
...
var setupBotAccount = function (ui, state) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        if (state.repoType == "github") {
            ...
            setup_bot_account_1.setupAzureDevopsAccount(ui, state);
        }
        else {
            setup_bot_account_1.setupUnknownRepoProvider(ui);
        }
        return [2 /*return*/];
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                return [3 /*break*/, 9];
            case 5:
                if (!(state.ciType === "azureDevops")) return [3 /*break*/, 7];
                return [4 /*yield*/, add_to_ci_1.azureDevops(ui)];
            case 6:
                _a.sent();
                return [3 /*break*/, 9];
            case 7: return [4 /*yield*/, add_to_ci_1.unsure(ui, state)];
            case 8:
                _a.sent();
                _a.label = 9;
