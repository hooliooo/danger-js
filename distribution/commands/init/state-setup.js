...
exports.generateInitialState = function (osProcess) {
    ...
    var hasAzureDevops = fs.existsSync("azure-pipelines.yml");
    //TODO - conditional statement won't scale
    var ciType = hasTravis ? "travis" : hasCircle ? "circle" : hasAzureDevops ? "azureDevops" : "unknown";
    var repoSlug = get_repo_slug_1.getRepoSlug();
    var repoType = get_repo_slug_1.getRepoInfo();
    return {
        isMac: isMac,
        isWindows: isWindows,
