...
exports.azureDevops = function (ui) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        // https://travis-ci.org/artsy/eigen/settings
        ...
        ui.say(interfaces_1.highlight("This approach is far more feature complete."));
        ui.say("2. Use AzureDevops as the CI provider (running danger). Use Azure Devops as the repo/PR provider.");
        ui.say(interfaces_1.highlight("This approach is incubating PRs are welcome!"));
        return [2 /*return*/];
    });
}); };
