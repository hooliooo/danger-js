...
commander_1.default
    ...
    if (!process.env["DANGER_GITHUB_API_TOKEN"] &&
        ...
        log("");
        log("     You don't have a DANGER_GITHUB_API_TOKEN/DANGER_GITLAB_API_TOKEN/DANGER_BITBUCKETCLOUD_UUID set up, this is optional, but TBH, you want to do this.");
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (app.json) {
                        ...
                        console.log(prettyjson_1.default.render(dsl));
                    }
                    return [2 /*return*/];
            }
        });
