    ...
    function BitBucketCloudAPI(repoMetadata, credentials) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, comments
                                ...
                                .filter(function (comment) { return comment.user.uuid === _this.credentials.uuid; })
                                .filter(function (comment) { return comment.content.raw.includes("Generated by"); })];
                }
            });
        }); };
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, comments.filter(function (comment) { return comment.inline; }).map(function (comment) { return ({
                                ...
                                ownedByDanger: comment.content.raw.includes(dangerIDMessage) && comment.user.uuid === _this.credentials.uuid,
        ...
        this.api = function (url, headers, body, method, suppressErrors) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                var params, authResponse, jsonResp;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 5:
                            ...
                            _a.label = 6;
                        case 6: return [2 /*return*/, this.performAPI(url, headers, body, method, suppressErrors)];
                    }
                });
            });
        };
