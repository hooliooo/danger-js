...
export declare const resultsToCheck: (results: DangerResults, options: ExecutorOptions, pr: GitHubPRDSL, api: any, ciCommitHash?: string | undefined, name?: string) => Promise<CheckOptions>;
